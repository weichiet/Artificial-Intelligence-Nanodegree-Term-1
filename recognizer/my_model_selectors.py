    ...
    def select(self):
        ...
        for n_components in range(self.min_n_components, self.max_n_components+1):        
            try:
                ...
                p = n_components**2 + (2 * self.X.shape[1] * n_components) - 1
    ...
    def select(self):
        ...
        for n_components in range(self.min_n_components, self.max_n_components + 1):
            try:
                ...
                sum_logL = sum(model.score(*self.hwords[word]) for word in self.hwords if word != self.this_word)
                
                dic = logL - np.average(sum_logL)
